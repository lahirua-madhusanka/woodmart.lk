...
router.put(
  ...
  [
    ...
    body("heroSlides")
      .optional()
      .isArray({ min: 1, max: 3 })
      .withMessage("Hero slides must contain between 1 and 3 slides"),
    body("heroSlides.*.imageUrl")
      .optional()
      .trim()
      .isURL()
      .withMessage("Each hero slide image must be a valid URL"),
    body("heroSlides.*.title")
      .optional()
      .trim()
      .isLength({ max: 180 })
      .withMessage("Hero slide title must be at most 180 characters"),
    body("heroSlides.*.subtitle")
      .optional()
      .trim()
      .isLength({ max: 400 })
      .withMessage("Hero slide subtitle must be at most 400 characters"),
    body("heroSlides.*.buttonText")
      .optional()
      .trim()
      .isLength({ max: 60 })
      .withMessage("Hero slide button text must be at most 60 characters"),
    body("heroSlides.*.buttonLink")
      .optional()
      .trim()
      .isLength({ max: 300 })
      .withMessage("Hero slide button link must be at most 300 characters"),
    body("heroSlides.*.displayOrder")
      .optional()
      .isInt({ min: 1, max: 3 })
      .withMessage("Hero slide order must be between 1 and 3"),
    body("heroSlides.*.status")
      .optional()
      .trim()
      .isIn(["active", "inactive"])
      .withMessage("Hero slide status must be active or inactive"),
    body("heroTitle")
      .optional()
      .trim()
      .isLength({ max: 180 })
